create or replace PACKAGE BODY             SF_AUTOPROCESS_ALARMS_PKG
AS
   /*=========================================================================================
   ...
   g_service_request_id           g_number_type;
...
END CLOSE_LOG_FILE;
   ...
   BEGIN
	...
	--       dbms_output.put_line('i_action_id =>'||i_action_id);--mritunjay
      ...
      IF i_processed_flag NOT IN ('P','M')
      THEN
...
PROCEDURE check_mobile_alarms (  p_alm_id            IN     NUMBER,
   ...
   BEGIN
      ...
      LOOP
        ...
        FOR exclude_source in (
              ...
              IF p_source = exclude_source.ex_s THEN
                v_source_adm_flag :='N';
        ...
        FOR exclude_description in (
          ...
          IF p_desc = exclude_description.ex_d THEN
            v_descr_adm_flag :='N';
        ...
        IF v_adm_config_swtich ='Y' THEN
          ...
          LOOP
            ...
            FOR support_description in (
              ...
              IF instr(p_desc,support_description.in_d) > 0 THEN
                v_adm_ml_support:='Y';
              END IF;
            END LOOP;
          END LOOP;
 ...
 /* chandra sep, 2018 salesforce commented, since mobile is available through community begin
    IF NOT v_auto_process_flag
         THEN
         --Check mobile Rule
            check_mobile_alarms (
