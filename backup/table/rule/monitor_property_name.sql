alter table jam.sf_message_config add field5 VARCHAR2(150);
/
...
END CLOSE_LOG_FILE;
   ...
   BEGIN
	...
	--       dbms_output.put_line('i_action_id =>'||i_action_id);--mritunjay
      ...
      --chandra Aug, 22
      IF i_processed_flag IN ('Y', 'P','M') AND i_action_id IS NOT NULL -- Added as per CR 229804 by Mritunjay Sinha November,29 2012
      THEN
      ...
      IF i_processed_flag NOT IN ('Y', 'P','M')
      THEN
